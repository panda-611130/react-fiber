...
const jsx = (
  <div className="border">
    <p>这是一个文本</p>
    <a href="https://github.com/panda-611130/react-ecology">其他仿写</a>
    <div className="border">
      <h5>hello</h5>
    </div>
...
//  ========= ********* ========== jsx babel会自动调用React中 createElement这个方法 将jsx通过CreateElement转换为Vnode！！！！所以有jsx 就要有React的引入 ========= ********* ==========
...
// function component
// fragment
// jsx====babel=====>createElement(生成element，就是我们需要的虚拟dom)=>render(vnode->node, 再把node渲染到container)
